...
public class Swerve {
    ...
    public static final double k_lf_abs_enc_offset = 1.0453741086274893;
    public static final double k_rf_abs_enc_offset = 5.101786074171632;
    public static final double k_lb_abs_enc_offset = 1.5343293935193625;
    public static final double k_rb_abs_enc_offset = 2.3980787050152528;

    // public static final double k_lf_abs_enc_offset = 1.095048386267275 - 0/180*Math.PI;     // LB
    // public static final double k_rf_abs_enc_offset = 5.115053482746271  + 3/180*Math.PI;
    // public static final double k_lb_abs_enc_offset = 1.4957074455038681 + 0/180*Math.PI;
